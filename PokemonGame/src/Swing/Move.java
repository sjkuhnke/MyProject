...
public enum Move {
	...
	COMET_CRASH(-1,90,0,0,0,0,PType.MAGIC,"Damage is doubled if user's HP is full",true),
	...
	DRAGON_TAIL(75,100,0,0,2,-6,PType.DRAGON,"",true), // TODO
	...
	EXTREME_SPEED(70,100,0,0,0,2,PType.FLYING,"Always goes first",true),
	...
	GLITTER_DANCE(0,1000,0,0,2,0,PType.LIGHT,"Raises user's Sp.Atk and Sp.Def by 1",false),
	...
	HAZE(0,1000,0,0,2,0,PType.GHOST,"Clears all stat changes on the field",false),
	...
	POISON_FANG(50,100,30,0,0,0,PType.POISON,"% to Poison and/or flinch foe",true),
	...
	TOXIC(0,100,0,0,2,0,PType.POISON,"Poisons foe",false),
