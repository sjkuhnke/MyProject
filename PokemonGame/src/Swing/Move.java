...
public enum Move {
	...
	BEAT_UP(60,100,50,0,0,0,PType.DARK,"% chance to cause foe to Bleed"),
	...
	BLUE_FLARE(150,90,50,0,1,0,PType.FIRE,"% chance to Burn foe"),
	BODY_SLAM(85,100,30,0,0,0,PType.NORMAL,"% chance to Paralyze foe"),
	BOLT_STRIKE(150,90,50,0,1,0,PType.ELECTRIC,"% chance to Paralyze foe"),
	...
	BRICK_BREAK(75,100,0,0,0,0,PType.FIGHTING,"Breaks Magic Reflect effects"),
	...
	BUG_BITE(60,100,0,0,0,0,PType.BUG,"Heals 50% of damage dealt to foe"),
	BUG_BUZZ(90,100,0,0,1,0,PType.BUG,"A normal attack"),
	...
	CHARM(0,100,0,0,2,0,PType.NORMAL,"Lowers foe's Attack by 2"),
	...
	COMET_PUNCH(-1,85,0,0,0,0,PType.MAGIC,"Attacks 2-5 times"),
	CONFUSE_RAY(0,100,0,0,2,0,PType.GHOST,"Confuses foe"),
	CONFUSION(50,100,10,0,1,0,PType.MAGIC,"% chance to Confuse foe"),
	CONSTRICT(10,100,50,0,0,0,PType.NORMAL,"% chance to lower foe's Speed by 1"),
	CROSS_POISON(70,100,30,1,0,0,PType.POISON,"% chance to Poison foe, boosted Crit rate"),
	...
	DIVE(80,90,0,0,0,0,PType.WATER,"A normal attack"),
	DOUBLE_BLAST(-1,60,30,0,1,0,PType.NORMAL,"% chance to Confuse foe"),
	DOUBLE_HIT(-1,95,0,0,0,0,PType.NORMAL,"Attacks twice"),
	DOUBLE_JET(-1,85,0,0,0,0,PType.WATER,"Attacks 2-5 times"),
	DOUBLE_KICK(-1,85,0,0,0,0,PType.FIGHTING,"Attacks twice"),
	...
	DOUBLE_EDGE(120,100,0,0,0,0,PType.NORMAL,"User takes 1/3 of damage inflicted"), // recoil
	...
	DRAGON_PULSE(90,100,0,0,1,0,PType.DRAGON,"A normal attack"),
	DRAGON_RAGE(0,100,0,0,1,0,PType.DRAGON,"Always does 40 HP damage"),
	DRAGON_RUSH(100,75,30,0,0,0,PType.DRAGON,"% chance of causing foe to flinch"),
	DRAGON_BREATH(60,100,30,0,1,0,PType.DRAGON,"% chance to Paralyze foe"),
	DREAM_EATER(100,100,0,0,1,0,PType.DARK,"Only works if target is asleep. Heals 50% of damage dealt to foe"),
	DRILL_PECK(80,100,0,1,0,0,PType.FLYING,"Boosted Crit rate"),
	...
	EXTRAORDINARY(-1,1000,0,0,1,0,PType.MAGIC,"Selects a random move!"),
	EXTREME_SPEED(70,100,0,0,0,0,PType.FLYING,"Always goes first"),
	FAINT_ATTACK(60,1000,0,0,0,0,PType.DARK,"This attack always hits"),
	FALSE_SWIPE(40,100,0,0,0,0,PType.BUG,"Always leaves the foe with at least 1 HP"),
	...
	FLARE_BLITZ(120,100,10,0,0,0,PType.FIRE,"% to Burn foe, user takes 1/3 of damage inflicted"), // recoil
	FLASH(0,100,0,0,2,0,PType.NORMAL,"Lowers foe's Accuracy by 1"),
	FLASH_CANNON(80,100,50,0,1,0,PType.STEEL,"% chance to lower foe's Sp.Def by 1"),
	...
	FRENZY_PLANT(150,90,0,0,1,0,PType.GRASS,"User must rest after using this move"), // recharge
	...
	GIGA_IMPACT(150,90,0,0,0,0,PType.NORMAL,"User must rest after using this move"), // recharge
	GLARE(0,100,0,0,2,0,PType.DARK,"Paralyzes foe"),
	GRASS_KNOT(80,100,0,0,1,0,PType.GRASS,"A normal attack"),
	...
	HEAD_SMASH(150,80,0,0,0,0,PType.ROCK,"User takes 1/3 of damage inflicted"), // recoil
	HEADBUTT(70,100,30,0,0,0,PType.NORMAL,"% chance of causing foe to flinch"),
	HEAT_WAVE(100,90,10,0,1,0,PType.FIRE,"% to Burn foe"),
	HI_JUMP_KICK(130,90,0,0,0,0,PType.FIGHTING,"If this attack misses, user takes 50% of its max HP"),
	HORN_ATTACK(65,100,0,0,0,0,PType.NORMAL,"A normal attack"),
	HORN_DRILL(0,30,0,0,0,0,PType.NORMAL,"If this move hits, it always K.Os foe"),
	HYDRO_CANNON(150,90,0,0,1,0,PType.WATER,"User must rest after using this move"), // recharge
	HYDRO_PUMP(120,80,0,0,1,0,PType.WATER,"A normal attack"),
	HYPER_BEAM(150,90,0,0,1,0,PType.NORMAL,"User must rest after using this move"), // recharge
	HYPER_FANG(80,90,10,0,0,0,PType.NORMAL,"% of causing foe to flinch"),
	HYPNOSIS(0,60,0,0,2,0,PType.GHOST,"Causes foe to sleep"),
	...
	LEAF_STORM(140,90,100,0,1,0,PType.GRASS,"% to lower user's Sp.Atk by 2"),
	LEAF_TORNADO(65,90,50,0,1,0,PType.GRASS,"% to lower foe's Accuracy by 1"),
	LEECH_LIFE(20,100,0,0,0,0,PType.BUG,"Heals 50% of damage dealt"),
	...
	LIGHTNING_HEADBUTT(90,95,30,0,0,0,PType.ELECTRIC,"% of Paralysis and/or causing foe to flinch. User takes 1/3 of damage dealt as recoil"), // recoil
	LOCK_ON(0,1000,0,0,2,0,PType.STEEL,"Raises user's Accuracy by 6"),
	LOW_KICK(60,100,100,0,0,0,PType.FIGHTING,"% to lower foe's Speed by 1"),
	MACH_PUNCH(40,100,0,0,0,1,PType.FIGHTING,"Always goes first"),
	MACHETE_STAB(75,80,100,0,0,0,PType.STEEL,"% to cause foe to Bleed"),
	MAGIC_BLAST(30,100,0,0,1,0,PType.MAGIC,"A random Rock, Ground or Grass move is also used"),
	MAGIC_CRASH(150,90,100,0,0,0,PType.MAGIC,"% to inflict foe with a random Status condition. User must rest after using"), // recharge
	...
	MOONLIGHT(0,1000,0,0,2,0,PType.MAGIC,"Restores 1/2 of user's max HP"),
	...
	SHELL_SMASH(0,1000,0,0,2,1,PType.NORMAL,"Raises user's Attack, Sp.Atk, and Speed by 2, at the cost of lowering its Defense and Sp.Def by 1"),
	PSYCHO_BLADE(70,100,0,1,0,0,PType.MAGIC,"Boosted Crit rate"),
	PUNCH(40,90,0,0,0,0,PType.FIGHTING,"A normal attack"),
	PURSUIT(40,100,0,0,0,0,PType.DARK,"A normal attack"),
	...
	SHELL_BASH(70,100,0,1,0,0,PType.NORMAL,"User takes 1/3 of damage dealt as recoil"), // recoil
	...
	SKULL_BASH(100,100,100,0,0,0,PType.NORMAL,"% to raise the user's Defense by 1, user must charge on the first turn"), // charge
	SKY_ATTACK(140,90,30,1,0,0,PType.FLYING,"% chance to flinch. User must charge up on the first turn, attacks on the second. Boosted Crit rate"), // charge
	...
	SOLAR_BEAM(120,100,0,0,1,0,PType.GRASS,"User must charge up on the first turn, attacks on the second"), // charge
	...
	STAR_STORM(110,85,0,0,1,0,PType.MAGIC,"A normal attack"),
	STARE(0,100,0,0,2,0,PType.NORMAL,"Confuses foe, but raises foe's Attack by 1"),
	...
	SUPER_CHARGE(90,50,100,0,0,0,PType.ELECTRIC,"% of causing foe to flinch, user takes 1/3 of damage dealt as recoil"), // recoil
	...
	SWORD_SLASH(75,90,0,1,0,0,PType.STEEL,"Boosted Crit rate"),
	...
	TAKE_DOWN(90,85,0,0,0,0,PType.NORMAL,"User takes 1/3 of damage dealt as recoil"), // recoil
	...
	THUNDERBOLT(95,100,10,0,1,0,PType.ELECTRIC,"% of Paralyzing foe"),
	...
	VINE_WHIP(35,100,0,0,0,0,PType.GRASS,"A normal attack"),
	VITAL_THROW(60,1000,0,0,0,0,PType.FIGHTING,"This attack never misses"),
	VOLT_TACKLE(120,100,10,0,0,0,PType.ELECTRIC,"% to Paralyze foe. User takes 1/3 of damage dealt as recoil"), // recoil
	...
	WOOD_FANG(50,100,50,0,0,0,PType.ROCK,"% to cause foe to flinch"),
	...
	ZEN_HEADBUTT(80,90,30,0,0,0,PType.MAGIC,"% of causing foe to flinch"),
	...
	ROCK_WRECKER(150,90,0,0,0,0,PType.ROCK,"User takes 1/3 of damage dealt as recoil"), // recoil
