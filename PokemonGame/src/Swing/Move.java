...
public enum Move {
	...
	BLAST_BURN(150,90,0,0,1,false,PType.FIRE),
	...
	BUG_BITE(60,100,100,0,0,false,PType.BUG),
	...
	CHOMP(70,100,100,0,0,false,PType.DARK),
	CLOSE_COMBAT(120,100,100,0,0,false,PType.FIGHTING),
	COMET(80,90,0,0,0,false,PType.MAGIC),
	COMET_PUNCH(10,85,0,0,0,false,PType.MAGIC),
	...
	DOUBLE_BLAST(40,60,10,0,1,false,PType.NORMAL),
	DOUBLE_HIT(35,95,0,0,1,false,PType.NORMAL),
	DOUBLE_JET(20,85,0,0,0,false,PType.WATER),
	DOUBLE_KICK(30,85,0,0,0,false,PType.FIGHTING),
	DOUBLE_PUNCH(30,85,0,0,0,false,PType.FIGHTING),
	DOUBLE_SLAP(15,95,0,0,0,false,PType.NORMAL),
	DOUBLE_SLICE(30,80,10,0,0,false,PType.STEEL),
	DOUBLE_TEAM(0,1000,0,0,2,false,PType.NORMAL),
	DOUBLE_EDGE(120,100,0,0,0,false,PType.NORMAL),
	DRACO_METEOR(140,100,0,0,1,false,PType.DRAGON),
	...
	DUAL_STAB(30,80,10,0,0,false,PType.STEEL),
	...
	ELECTROEXPLOSION(300,100,1000,0,1,false,PType.ELECTRIC),
	...
	FIRE_SPIN(35,85,0,0,1,false,PType.FIRE),
	...
	FLARE_BLITZ(120,100,0,0,0,false,PType.FIRE),
	...
	FRENZY_PLANT(150,90,0,0,1,false,PType.GRASS),
	FRUSTERATION(104,100,0,0,0,false,PType.NORMAL),
	FURY_ATTACK(15,85,0,0,0,false,PType.NORMAL),
	FURY_CUTTER(20,95,0,0,0,false,PType.BUG),
	FURY_SWIPES(15,80,0,0,0,false,PType.NORMAL),
	...
	GUNSHOT(70,60,0,1,0,false,PType.STEEL),
	...
	HEAD_SMASH(150,80,0,0,0,false,PType.ROCK),
	...
	KARATE_CHOP(50,100,0,1,0,false,PType.FIGHTING),
	...
	LEAF_PULSE(85,75,50,0,1,false,PType.GRASS),
	...
	MAGIC_CRASH(150,90,100,0,0,false,PType.MAGIC),
	MAGIC_FANG(70,95,75,0,0,false,PType.MAGIC),
	MAGIC_REFLECT(0,1000,0,0,2,false,PType.MAGIC),
	MAGIC_TOMB(90,90,100,0,0,false,PType.MAGIC),
	...
	PROTECT(0,1000,0,0,2,true,PType.NORMAL),
	...
	RAGE(20,100,0,0,0,false,PType.NORMAL),
	...
	REVENGE(60,100,0,0,0,false,PType.FIGHTING),
	ROCK_BLADE(80,100,0,1,0,false,PType.ROCK),
	ROCK_BLAST(25,90,0,0,0,false,PType.ROCK),
	...
	ROLLOUT(30,90,0,0,0,false,PType.ROCK),
	...
	SHELL_BASH(70,100,0,0,0,false,PType.NORMAL),
	SHOCK(15,100,0,0,1,false,PType.ELECTRIC),
	SHOCK_WAVE(60,1000,0,0,1,false,PType.ELECTRIC),
	SHURIKEN(75,85,50,0,0,false,PType.STEEL),
	SKULL_BASH(100,100,100,0,0,false,PType.NORMAL),
	SKY_ATTACK(140,90,30,1,0,false,PType.FLYING),
	...
	STAR_STORM(100,85,0,0,0,false,PType.MAGIC),
	...
	SWEEP_KICK(60,95,0,0,0,false,PType.FIGHTING),
	...
	TAILWIND(0,1000,0,0,2,false,PType.FLYING),
	TAKE_DOWN(90,85,0,0,0,false,PType.NORMAL),
	TAKE_OVER(0,100,0,0,2,false,PType.GHOST),
	TAUNT(0,100,0,0,2,false,PType.DARK),
	...
	TORMENT(0,100,0,0,2,false,PType.DARK),
	TORNADO_SPIN(60,95,0,0,0,false,PType.FIGHTING),
	TOXIC(0,100,0,0,2,false,PType.POISON),
	TOXIC_SPIKES(0,100,0,0,2,false,PType.POISON),
	TWISTER(40,100,10,0,1,false,PType.DRAGON),
	U_TURN(70,100,100,0,0,false,PType.BUG),
	VINE_WHIP(35,100,0,0,0,false,PType.GRASS),
	VITAL_THROW(70,1000,0,0,0,false,PType.FIGHTING),
	VOLT_TACKLE(120,100,10,0,0,false,PType.ELECTRIC),
	WAKE_UP_SLAP(60,100,100,0,0,false,PType.FIGHTING),
	...
	WHIRLWIND(0,1000,0,0,2,false,PType.FLYING),
	WILL_O_WISP(0,75,0,0,2,false,PType.FIRE),
