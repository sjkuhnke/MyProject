...
public enum Move {
	ABDUCT(0,100,0,0,2,0,PType.GALACTIC,""), // TODO
	ABSORB(20,100,0,0,1,0,PType.GRASS,"Heals 50% of damage dealt to foe"),
	ACCELEROCK(40,100,0,0,0,1,PType.ROCK,""),
	ACID(40,100,10,0,1,0,PType.POISON,"% chance to lower foe's Sp.Def by 1"),
	ACID_ARMOR(0,1000,0,0,2,0,PType.POISON,""), // TODO
	ACID_SPRAY(40,100,100,0,1,0,PType.POISON,""), // TODO
	ACROBATICS(-1,100,0,0,0,0,PType.FLYING,""), // TODO
	AERIAL_ACE(60,1000,0,0,0,0,PType.FLYING,""), // TODO
	...
	AURORA_BEAM(65,100,10,0,1,0,PType.ICE,""), // TODO
	...
	BEEFY_BASH(0,100,0,0,0,0,PType.FIGHTING,""), // TODO
	BELCH(120,100,0,0,1,0,PType.POISON,"Only works on the first turn out"), // TODO
	//BIG_BULLET(70,90,30,0,0,0,PType.STEEL,"% chance to Paralyze foe"),
	BIND(20,85,100,0,0,0,PType.NORMAL,""), // TODO
	...
	BLACK_HOLE_ECLIPSE(140,100,100,0,1,0,PType.GALACTIC,""), // TODO
	BLAZE_KICK(85,90,10,1,0,0,PType.FIRE,""), // TODO
	...
	BLIZZARD(110,70,10,0,1,0,PType.ICE,""), // TODO
	BLUE_FLARE(130,85,20,0,1,0,PType.FIRE,"% chance to Burn foe"), //TODO
	BODY_PRESS(80,100,0,0,0,0,PType.FIGHTING,""), // TODO
	BODY_SLAM(85,100,30,0,0,0,PType.NORMAL,"% chance to Paralyze foe"),
	BOLT_STRIKE(130,85,20,0,0,0,PType.ELECTRIC,"% chance to Paralyze foe"), //TODO
	...
	BRANCH_POKE(40,100,0,0,0,0,PType.GRASS,""), // TODO
	...
	BRUTAL_SWING(60,100,0,0,0,0,PType.DARK,""), // TODO
	BUBBLE(20,100,0,0,1,0,PType.WATER,"A normal attack"),
	BUBBLEBEAM(65,100,10,0,1,0,PType.WATER,"% to lower foe's Speed by 1"),
	BUG_BITE(60,100,0,0,0,0,PType.BUG,"Heals 50% of damage dealt to foe"), //TODO
	BUG_BUZZ(90,100,10,0,1,0,PType.BUG,"A normal attack"), //TODO
	BULK_UP(0,1000,0,0,2,0,PType.FIGHTING,"Raises user's Attack and Defense by 1"),
	BULLDOZE(0,100,0,0,2,0,PType.GALACTIC,""), // TODO
	BULLET_PUNCH(40,100,0,0,0,1,PType.STEEL,"Always goes first"),
	BURN_UP(60,100,100,0,0,0,PType.GROUND,""), // TODO
	...
	CHARGE_BEAM(50,90,50,0,1,0,PType.ELECTRIC,""), // TODO
	...
	COIL(0,1000,0,0,2,0,PType.POISON,""), // TODO
	...
	CORE_ENFORCER(100,100,10,0,1,0,PType.GALACTIC,""), // TODO
	COSMIC_POWER(0,1000,0,0,2,0,PType.GALACTIC,""), // TODO
	COTTON_GUARD(0,1000,0,0,2,0,PType.GRASS,""), // TODO
	COUNTER(-1,100,0,0,0,-5,PType.FIGHTING,""), // TODO
	CROSS_CHOP(100,80,0,1,0,0,PType.FIGHTING,""), // TODO
	...
	DARKEST_LARIAT(85,100,0,0,0,0,PType.DARK,""), // TODO
	DAZZLING_GLEAM(80,100,0,0,1,0,PType.LIGHT,""), // TODO
	...
	DESOLATE_VOID(65,85,50,0,1,0,PType.GALACTIC,""), // TODO
	...
	DIAMOND_STORM(100,95,50,0,0,0,PType.FIGHTING,""), // TODO
	...
	DRAIN_PUNCH(75,100,0,0,0,0,PType.FIGHTING,""), // TODO
	DRAINING_KISS(50,100,0,0,1,0,PType.LIGHT,""), // TODO
	...
	ELECTRIC_TERRAIN(0,1000,0,0,2,0,PType.ELECTRIC,""), // TODO
	...
	FELL_STINGER(50,100,0,0,0,0,PType.BUG,""), // TODO
	FIERY_DANCE(80,100,50,0,2,0,PType.FIRE,""), // TODO
	...
	FISSURE(0,30,0,0,0,0,PType.GROUND,""), // TODO
	...
	FLAME_CHARGE(50,100,100,0,0,0,PType.FIRE,""), // TODO
	...
	FLASH(0,100,0,0,2,0,PType.LIGHT,"Lowers foe's Accuracy by 1"), //TODO
	FLASH_CANNON(80,100,10,0,1,0,PType.STEEL,"% chance to lower foe's Sp.Def by 1"), //TODO
	FLASH_RAY(40,100,50,0,1,0,PType.LIGHT,""), // TODO
	FLATTER(0,100,100,0,2,0,PType.DARK,""), // TODO
	FLY(90,100,0,0,0,0,PType.FLYING,"A normal attack"), //TODO
	FOCUS_BLAST(120,70,0,0,1,0,PType.FIGHTING,""), // TODO
	FOCUS_ENERGY(0,1000,0,0,2,0,PType.NORMAL,""), // TODO
	FOCUS_PUNCH(150,100,0,0,0,0,PType.FIGHTING,""), // TODO
	FORCE_PALM(60,100,30,0,0,0,PType.FIGHTING,""), // TODO
	...
	FORESTS_CURSE(0,100,0,0,2,0,PType.GRASS,""), // TODO
	FOUL_PLAY(95,100,0,0,0,0,PType.DARK,""), // TODO
	FREEZE_DRY(70,100,10,0,1,0,PType.ICE,""), // TODO
	FREEZING_GLARE(90,100,10,0,1,0,PType.PSYCHIC,""), // TODO
	...
	FUSION_BOLT(100,100,0,0,0,0,PType.ELECTRIC,""), // TODO
	FUSION_FLARE(100,100,0,0,1,0,PType.FIRE,""), // TODO
	...
	GALAXY_BLAST(90,100,0,0,1,0,PType.GALACTIC,""), // TODO
	GASTRO_ACID(0,100,0,0,2,0,PType.POISON,""), // TODO
	GENESIS_SUPERNOVA(120,95,0,0,1,0,PType.GALACTIC,""), // TODO
	...
	GLACIATE(65,95,100,0,1,0,PType.ICE,""), // TODO
	GLARE(0,100,0,0,2,0,PType.NORMAL,"Paralyzes foe"),
	GLITTER_DANCE(0,1000,0,0,2,0,PType.LIGHT,""), // TODO
	GLITTERING_SWORD(95,100,20,0,0,0,PType.LIGHT,""), // TODO
	GLITTERING_TORNADO(55,100,30,0,1,0,PType.LIGHT,""), // TODO
	GLITZY_GLOW(80,100,30,0,1,0,PType.LIGHT,""), // TODO
	GRASS_KNOT(80,100,0,0,1,0,PType.GRASS,"A normal attack"), // TODO
	GRASS_WHISTLE(0,55,0,0,2,0,PType.GRASS,""), // TODO
	GRASSY_TERRAIN(0,1000,0,0,2,0,PType.GRASS,""), // TODO
	//GRASS_PUNCH(80,100,0,0,0,0,PType.GRASS,"A normal attack"),
	GRAVITY(0,1000,0,0,2,0,PType.GALACTIC,""), // TODO
	...
	GUILLOTINE(0,30,0,0,0,0,PType.NORMAL,""), // TODO
	...
	HAIL(0,1000,0,0,2,0,PType.ICE,""), // TODO
	...
	HEAL_PULSE(0,1000,0,0,2,0,PType.PSYCHIC,""), // TODO
	...
	HONE_CLAWS(0,1000,0,0,2,0,PType.DARK,""), // TODO
	...
	HORN_LEECH(75,100,0,0,0,0,PType.GRASS,""), // TODO
	HOWL(0,1000,0,0,2,0,PType.NORMAL,""), // TODO
	HURRICANE(110,70,30,0,1,0,PType.FLYING,""), // TODO
	...
	ICE_BEAM(90,100,10,0,1,0,PType.ICE,""), // TODO
	ICE_FANG(65,95,10,0,0,0,PType.ICE,""), // TODO
	ICE_PUNCH(75,100,10,0,0,0,PType.ICE,""), // TODO
	ICE_SHARD(40,100,0,0,0,1,PType.ICE,""), // TODO
	ICE_SPINNER(80,100,100,0,0,0,PType.ICE,""), // TODO
	ICICLE_CRASH(85,90,30,0,0,0,PType.ICE,""), // TODO
	ICICLE_SPEAR(25,100,0,0,0,0,PType.ICE,""), // TODO
	ICY_WIND(55,95,100,0,1,0,PType.ICE,""), // TODO
	//IGNITE(0,75,0,0,2,0,PType.FIRE,"Burns foe"),
	IMPRISON(0,1000,0,0,2,0,PType.PSYCHIC,""), // TODO
	INCINERATE(60,100,0,0,1,0,PType.FIRE,""), // TODO
	INFERNO(100,50,100,0,1,0,PType.FIRE,""), // TODO
	INFESTATION(20,100,100,0,1,0,PType.BUG,""), // TODO
	INGRAIN(0,1000,0,0,2,0,PType.GRASS,""), // TODO
	//INJECT(55,100,100,0,0,0,PType.BUG,"% to Poison foe, heals 50% of damage dealt"),
	IRON_BLAST(85,90,30,0,1,0,PType.STEEL,""), // TODO
	...
	LEAFAGE(40,100,0,0,0,0,PType.GRASS,""), // TODO
	...
	LIFE_DEW(0,1000,0,0,2,0,PType.WATER,""), // TODO
	LIGHT_BEAM(60,100,20,0,1,0,PType.LIGHT,""), // TODO
	LIGHT_OF_RUIN(140,90,0,0,1,0,PType.LIGHT,""), // TODO
	LIGHT_SCREEN(0,1000,0,0,2,0,PType.PSYCHIC,""), // TODO
	LIQUIDATION(85,100,20,0,0,0,PType.WATER,""), // TODO
	...
	LOW_SWEEP(65,100,100,0,0,0,PType.FIGHTING,""), // TODO
	LUNAR_DANCE(0,1000,0,0,2,0,PType.PSYCHIC,""), // TODO
	LUSTER_PURGE(70,100,50,0,1,0,PType.LIGHT,""), // TODO
	...
	MAGIC_CRASH(150,90,100,0,0,0,PType.MAGIC,"% to inflict foe with a random Status condition. User must rest after using"),
	...
	MAGNET_BOMB(60,1000,0,0,0,0,PType.STEEL,""), // TODO
	...
	MEGAHORN(120,85,0,0,0,0,PType.BUG,""), // TODO
	MEMENTO(0,100,0,0,2,0,PType.DARK,""), // TODO
	METAL_CLAW(50,95,0,0,0,0,PType.STEEL,""), // TODO
	...
	METEOR_ASSAULT(120,100,100,0,0,0,PType.GALACTIC,""), // TODO
	METEOR_MASH(90,90,20,0,0,0,PType.STEEL,""), // TODO
	...
	MOLTEN_STEELSPIKE(100,100,30,0,1,0,PType.FIRE,""), // TODO
	MOONBLAST(95,100,30,0,1,0,PType.LIGHT,""), // TODO
	...
	NUZZLE(20,100,100,0,0,0,PType.ELECTRIC,""), // TODO
	...
	PARABOLIC_CHARGE(65,100,0,0,1,0,PType.ELECTRIC,""), // TODO
	PAYBACK(50,100,0,0,0,0,PType.DARK,""), // TODO
	...
	PETAL_BLIZZARD(90,100,0,0,0,0,PType.GRASS,""), // TODO
	PETAL_DANCE(120,100,0,0,1,0,PType.GRASS,""), // TODO
	PHANTOM_FORCE(100,100,0,0,0,0,PType.GHOST,""), // TODO
	PHOTON_GEYSER(130,90,100,0,1,0,PType.LIGHT,""), // TODO
	PIN_MISSILE(25,95,0,0,0,0,PType.BUG,""), // TODO
	PISTOL_POP(110,70,0,0,0,0,PType.STEEL,""), // TODO
	PLASMA_FISTS(100,100,0,0,0,0,PType.ELECTRIC,""), // TODO
	PLAY_NICE(0,100,0,0,2,0,PType.NORMAL,""), // TODO
	PLAY_ROUGH(90,90,10,0,0,0,PType.LIGHT,""), // TODO
	PLUCK(60,100,0,0,0,0,PType.FLYING,""), // TODO
	...
	POWDER_SNOW(40,100,10,0,1,0,PType.ICE,""), // TODO
	POWER_GEM(80,100,0,0,1,0,PType.ROCK,""), // TODO
	POWER_WHIP(120,85,0,0,0,0,PType.GRASS,""), // TODO
	POWER_UP_PUNCH(40,100,100,0,0,0,PType.FIGHTING,""), // TODO
	PRISMATIC_LASER(100,100,0,0,1,0,PType.LIGHT,""), // TODO
	PROTECT(0,1000,0,0,2,4,PType.NORMAL,""), // TODO
	PSYBEAM(65,100,10,0,1,0,PType.PSYCHIC,""), // TODO
	PSYCHIC(90,100,10,0,1,0,PType.PSYCHIC,""), // TODO
	...
	RAZOR_SHELL(75,95,50,0,0,0,PType.WATER,""), // TODO
	...
	ROUND(60,100,0,0,1,0,PType.NORMAL,""), // TODO
	SACRED_FIRE(100,95,50,0,0,0,PType.FIRE,""), // TODO
	SACRED_SWORD(90,100,0,0,0,0,PType.FIGHTING,""), // TODO
	...
	SHADOW_CLAW(70,100,0,1,0,0,PType.GHOST,""), // TODO
	SHADOW_PUNCH(60,1000,0,0,0,0,PType.GHOST,""), // TODO
	SHADOW_SNEAK(40,100,0,0,0,1,PType.GHOST,"Always attacks first"),
	SHEER_COLD(0,30,0,0,1,0,PType.ICE,""), // TODO
	...
	SILVER_WIND(60,100,10,0,1,0,PType.BUG,""), // TODO
	...
	SLUDGE_WAVE(95,100,10,0,1,0,PType.POISON,""), // TODO
	SMACK_DOWN(50,100,100,0,0,0,PType.ROCK,""), // TODO
	SMART_STRIKE(70,1000,0,0,0,0,PType.STEEL,""), // TODO
	...
	SNARL(55,95,0,0,1,0,PType.DARK,""), // TODO
	...
	SPACE_BEAM(60,100,30,0,1,0,PType.GALACTIC,""), // TODO
	SPACIAL_REND(100,95,0,1,1,0,PType.GALACTIC,""), // TODO
	SPARK(65,100,30,0,0,0,PType.ELECTRIC,"% to Paralyze foe"),
	SPARKLE_STRIKE(80,1000,0,0,0,0,PType.MAGIC,""), // TODO
	SPARKLING_ARIA(90,100,100,0,1,0,PType.WATER,""), // TODO
	SPARKLING_TERRAIN(0,1000,0,0,2,0,PType.MAGIC,""), // TODO
	SPARKLING_WATER(0,100,0,0,2,0,PType.WATER,""), // TODO
	SPARKLY_SWIRL(70,100,10,0,1,0,PType.MAGIC,""), // TODO
	SPECTRAL_THIEF(90,100,100,0,0,0,PType.GHOST,""), // TODO
	SPEEDY_SHURIKEN(40,100,0,0,0,1,PType.STEEL,""), // TODO
	...
	SPIRIT_BREAK(75,100,100,0,2,0,PType.LIGHT,""), // TODO
	...
	STRUGGLE_BUG(50,100,100,0,1,0,PType.BUG,""), // TODO
	...
	SUBMISSION(80,90,0,0,0,0,PType.FIGHTING,""), // TODO
	...
	SUNSTEEL_STRIKE(100,100,0,0,0,0,PType.STEEL,""), // TODO
	...
	SUPERNOVA_EXPLOSION(200,100,0,0,1,0,PType.GALACTIC,""), // TODO
	...
	TRI_ATTACK(80,100,20,0,1,0,PType.NORMAL,""), // TODO
	TRICK_ROOM(0,1000,0,0,2,-7,PType.PSYCHIC,""), // TODO
	TWINKLE_TACKLE(85,90,20,0,0,0,PType.MAGIC,""), // TODO
	TWINNEEDLE(25,100,20,0,0,0,PType.BUG,""), // TODO
	...
	VACUUM_WAVE(40,100,0,0,1,1,PType.FIGHTING,""), // TODO
	V_CREATE(180,95,100,0,0,0,PType.FIRE,""), // TODO
	VENOM_DRENCH(0,100,0,0,2,0,PType.POISON,""), // TODO
	VENOSHOCK(65,100,0,0,1,0,PType.POISON,""), // TODO
	VISE_GRIP(55,100,0,0,0,0,PType.NORMAL,""), // TODO
	...
	WAVE_CRASH(120,100,0,0,0,0,PType.WATER,""), // TODO
